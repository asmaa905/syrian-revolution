    ...
    <div className="mt-[20px] mx-auto w-[80%]">
      ...
      <div className='containerinputrevloution'>
        <div className='inputrevloution'>
          <label htmlFor="" className="text-[12px]"> عنوان الارشيف </label>
          <input
            type="text"
        ...
        <div className='inputrevloution'>
          ...
          <label htmlFor="f1" className='fileuploadrevlotion'>
            {" "}
            ارفع الصورة هنا
          </label>
          <input
      ...
      <div className='contentrevloution'>
        <label htmlFor="" className="text-[12px]"> محتوي الارشيف</label>
        <textarea
          name="content"
          id=""

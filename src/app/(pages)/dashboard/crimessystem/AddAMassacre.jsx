    ...
    <div className='mt-[20px] mx-auto w-[80%]'>
      ...
      <div className='containerinputrevloution'>
        <div className='inputrevloution'>
          <label htmlFor="" className="text-[12px]"> عنوان الجريمة</label>
          <input
      ...
      <div className='containerinputrevloution'>
        <div className='inputrevloution'>
          ...
          <label htmlFor="ui2" className="fileuploadrevlotion">
            {" "}
            ارفع الملف هنا
          </label>
          <input
      ...
      <div className='contentrevloution'>
        <label htmlFor="" className="text-[12px]"> تفاصيل الجريمة</label>
        <textarea
          onChange={handlechange}
          name="details"

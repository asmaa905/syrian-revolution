...
import styles from "@/app/css/styleDashboard/DisplayMartysDash.module.css";
...
export default function DisplayTraitorsDash({ params }) {
    ...
    await axios
      ...
      .then((response) => {
        ...
        if (response.data === "list Deleted Successfully") {
          setLoading(false);
          router.push("/dashboard/traitors");
        }
      })
